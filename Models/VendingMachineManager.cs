...
namespace VendingMachine {
    ...
    public class CocaColaVendingMachineManager : IVendingMachineManager {
        private readonly List < (IProduct product, uint quantity) > products = new List < (IProduct product, uint quantity) > () {
            (new Drink("Coca-Cola", "The Cola-flavored classic!", 14, 1, extraStoreMarkupFactor : 1.1m), 30),
            (new Drink("Sprite", "Kids think it's cool to drink.", 12, 1, extraStoreMarkupFactor : 1.1m), 15),
            (new Drink("Fanta", "The war-time Cola alternative.", 13, 1, extraStoreMarkupFactor : 1.1m), 20),
            (new Drink("Vanilla Coke", "The war-time Cola alternative.", 13, 1, extraStoreMarkupFactor : 1.1m), 20),
        };
